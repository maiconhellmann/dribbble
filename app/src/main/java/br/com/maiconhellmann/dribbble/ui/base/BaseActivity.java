...
import br.com.maiconhellmann.dribbble.injection.component.ActivityComponent;
import br.com.maiconhellmann.dribbble.injection.component.ConfigPersistentComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!sComponentsMap.containsKey(mActivityId)) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(DribbbleApplication.get(this).getComponent())
                    .build();
